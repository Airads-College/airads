...
def register_page(request):
    ...
    if request.method == "POST":
        ...
        # Public self-registration always creates a learner account. Instructor
        # access is granted explicitly by an administrator through user
        # management, so client-supplied role values are intentionally ignored.
        login(request, user, backend="apps.core.backends.EmailBackend")
