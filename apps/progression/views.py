...
def instructor_students(request, pk: int):
    """Compatibility route for the shared course learner workspace."""
    from apps.learning_operations.page_views import instructor_course_students

    return instructor_course_students(request, program_id=pk)


@login_required
def instructor_student_detail(request, pk: int, enrollment_id: int):
    """Compatibility route for the shared course learner detail page."""
    from apps.learning_operations.page_views import instructor_course_learner

    return instructor_course_learner(
        request,
        program_id=pk,
        enrollment_id=enrollment_id,
    )
