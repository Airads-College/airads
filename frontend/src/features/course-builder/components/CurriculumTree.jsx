...
export default function CurriculumTree({
    ...
    const handleDragEnd = (event) => {
        ...
        if (active.id !== over?.id) {
            ...
            router.post(
                `/instructor/programs/${program.id}/nodes/reorder/`,
                {
    ...
    const quizTitleError =
        quizTitle.length > 0 && trimmedQuizTitleLength < NODE_TITLE_MIN_LENGTH;
    const createTitleError =
        createTitle.length > 0 &&
        trimmedCreateTitleLength < NODE_TITLE_MIN_LENGTH;
    ...
    const saveSectionTitle = () => {
        if (editingSectionId && editingSectionTitle.trim()) {
            router.post(
                `/instructor/nodes/${editingSectionId}/update/`,
                {
    ...
    const handleLessonTypeSelect = (type) => {
        ...
        router.post(
            `/instructor/programs/${program.id}/nodes/create/`,
            payload,
            {
                preserveScroll: true,
                onSuccess: (page) => {
                    ...
                    if (page.props.curriculum) {
                        ...
                        const newNodesFlat = flattenNodes(
                            page.props.curriculum,
                        );
                        const createdNode = newNodesFlat.find(
                            (n) => !oldIds.has(n.id),
                        );
                        ...
                        console.error(
                            "No curriculum in response - backend may need update",
                        );
                    }
                },
                onError: (errors) => {
    ...
    const handleDeleteConfirm = () => {
        ...
        router.post(
            `/instructor/nodes/${nodeId}/delete/`,
            {},
            {
                preserveScroll: true,
                onSuccess: () => {
                ...
                <ListItem disablePadding sx={{ mb: 0.5 }}>
                    ...
                    >
                        ...
                        <Box
                            component={Icon}
                            sx={{
                                color: isSelected ? "primary.main" : iconColor,
                                fontSize: 18,
                                mr: 1.5,
                            }}
                        />
                ...
                >
                    ...
                    >
                        ...
                        <Box sx={{ display: "flex" }}>
                            <IconButton
                                size="small"
                                onClick={(e) => startEditingSection(node, e)}
                            >
                        ...
                        <Box sx={{ p: 1 }}>
                            ...
                            <Stack direction="row" spacing={1} mt={1}>
                                ...
                                <Button
                                    ...
                                    onClick={() =>
                                        openSearchModal(node.id, node.title)
                                    }
                                >
                                    Search
                                </Button>
                    ...
                    {!localNodes || localNodes.length === 0 ? (
                        ...
                        >
                            ...
                            <Typography variant="caption">
                                Start by adding your first {containerLabel}.
                            </Typography>
                        </Box>
                    ) : (
                        <DndContext
                            ...
                            >
                                ...
                                <List disablePadding>
                                    ...
                                    >
                                        ...
                                        <ListItemText
                                            primary="Quiz"
                                            secondary="Test student knowledge"
                                        />
                                    </ListItemButton>
                                    <ListItemButton
                                        onClick={() =>
                                            handleLessonTypeSelect("assignment")
                                        }
                                    >
                                        <Box
                                            component="span"
                                    ...
                                    <List disablePadding>
                                        ...
                                        >
                                            ...
                                            <ListItemText
                                                ...
                                                secondary="Evidence-based competency proof"
                                            />
                                        </ListItemButton>
                                    </List>
                                </Box>
                ...
                <DialogActions>
                    {(createQuizModalOpen || createType === "section") && (
                        <Button
                            ...
                            disabled={
                                createQuizModalOpen
                                    ? trimmedQuizTitleLength <
                                      NODE_TITLE_MIN_LENGTH
                                    : trimmedCreateTitleLength <
                                      NODE_TITLE_MIN_LENGTH
                            }
                        >
                            Create
